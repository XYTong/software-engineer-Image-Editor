...
and it worked properly) feel free to remove it. 

As you can see theres a lack of comments in the Code. Im going to fix this over the 
weekend, but its presumably a good idea, and would be appreciated, for those who are
trying to understand the code to write comments too wherever necessary.

Version 0 
(Since i dont know the proper way of version numbering :D )
